...
nmf_model = NMF(n_components=8,random_state=42, beta_loss='kullback-leibler', solver='mu', init='nndsvda')           
nmf_model.fit(dtm)
...
plots_functions.plot_NMF(
    nmf_model, tfidf_feature_names, 15, "", f'all_db_abstract_{datestr}', "kullbackrem"
)
